...
|---|---|---|---|---|
| SK Hynix | ~62% (HBM4 NVIDIA 최초 인증) · 점유 62% | +0.04 (2026-07-28) | SK하이닉스가 엔비디아와 대형 계약을 맺었지만 미국 상장 주식의 변동성이 계속돼 판단을 유보할 상태다 | [000660.KS](../../tickers/000660.KS - SK Hynix.md) |
| Micron | ~21% (’26 완판) · 점유 21% | -0.11 (2026-07-28) | 중국 CXMT 상장 충격으로 메모리주가 흔들렸지만 마이크론의 HBM 기술 우위는 아직 훼손되지 않았다 | [MU](../../tickers/MU - Micron Technology.md) |
| Samsung | ~17% (HBM4 Rubin 인증, 컴백중) · 점유 17% | +0.10 (2026-07-28) | 삼성전자가 브로드컴과 200억달러 규모 대형 반도체 계약을 맺으며 메모리와 파운드리 양쪽에서 입지를 넓혔다 | [005930.KS](../../tickers/005930.KS - Samsung Electronics.md) |
<!-- PLAYERS_END -->
...
- [HBM — 구조·공정·병목](../../../wiki/concepts/hbm.md)
