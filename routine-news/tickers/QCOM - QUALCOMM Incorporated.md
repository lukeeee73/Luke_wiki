...
- [ ] **2026-07-21**: 중화권 3사(샤오미·오포·비보) 출하 축소가 퀄컴 QCT(칩 사업부) 매출에 실제로 얼마나 반영되는가 — 이렇게 확인된다: 7/29 Q3 FY2026 실적에서 핸드셋 부문 매출·가이던스 (7/29 확인)
- [ ] **2026-07-21**: 데이터센터 AI 칩 사업 확대가 핸드셋 둔화를 상쇄할 만큼 빠르게 크는가 — 이렇게 확인된다: 7/29 실적에서 비핸드셋 매출 비중 변화 (7/29 확인)
...
- [ ] **2026-07-28**: 7/29 Q3 실적에서 3개월 새 -19.5% 낮아진 EPS 컨센서스($2.23)를 실제로도 밑도는가, 아니면 4분기 연속 서프라이즈를 이어가는가 — 이렇게 확인된다: 7/29 실적 발표 (7/29 확인)
<!-- OPEN_CLAIMS_END -->
