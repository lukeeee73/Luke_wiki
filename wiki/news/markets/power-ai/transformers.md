...
weight: reference
confidence: low
tags: [routine-news, market-summary, power-ai, transformers]
map: power-ai
market_id: transformers
sources: ["https://zdnet.co.kr/view/?no=20260206190629", "https://www.sedaily.com/NewsView/2H0I41MC9B", "https://pv-magazine-usa.com/2026/05/11/u-s-transformer-market-faces-severe-supply-constraints-as-lead-times-extend-to-four-years/"]
---

# 변압기 · 스위치기어 · HVDC — 시장 종합

**Transformers, Switchgear & HVDC** · ⑤ 발전·전력 장비 · 규모 대형 변압기 리드타임 4~5년 · K-빅3 수주잔고 30조+ (5년치 일감) · 성장 K-빅3 ’25 합산 매출 15조 · 영업익 2.2조 사상최대

> [!info] 자동 종합 노트
> 이 파일은 시장지도 노드 `transformers` 의 종합 페이지다. `indicator_dashboard` 루틴이 관리한다 —
...
전력을 승압·배분하는 그리드 장비 — 리드타임이 DC 준공 일정을 좌우하는 실물 병목.

**수요 동인** — DC 인입·변전소 + 노후 교체 + 재생·가스 신설 접속의 3중 수요. BTM 조차 구내 변전 장비는 필요.

## 병목 상태 — 🔴 급성 병목 (`acute`)

> [!claim] (출처: 시장지도 as_of 2026-07)
> GOES 전기강판·권선 숙련공·시험 설비가 증산 상한 — 리드타임 4~5년, 미국 신규 DC 지연의 최대 단일 원인. 증설(효성 미국 공장·Quanta 내재화)은 ’27+ 에야 유효 공급.
...
|---|---|---|---|---|
| GE Vernova (Electrification) | 그리드 장비 — 차단기·스위치기어·계기용변압기 | ⚪ -0.02 (2026-09-11) | 스코틀랜드 소규모 풍력 터빈 공급계약 외 특별한 소식 없이 주가가 조정받았고, 경쟁사 두산에너빌리티가 한미 원전·가스발전 수혜주로 부각되며 대조를 이뤘다. | [GEV](../../tickers/GEV - GE Vernova Inc.md) |
| Eaton | 북미 전력기기 종합 — 변압기·스위치기어·DC 배전 | 🟢 +0.16 (2026-09-11) | UBS가 마진 개선을 근거로 목표가를 515달러로 대폭 올렸고 아칸소 신공장 투자까지 발표되며 전력 인프라 종목 중 가장 뚜렷한 호재를 누렸다. | [ETN](../../tickers/ETN - Eaton Corporation plc.md) |
| Hitachi Energy | HVDC·대형 변압기 글로벌 강자 (히타치 부문) | — | — | 비상장 |
| HD현대일렉트릭 | 북미 대형 변압기 — ’25 영업익 1조 돌파 | 🟢 +0.14 (2026-09-11) | 북미 초고압변압기 시장 점유율 1위를 유지하며 수주잔고가 85억달러(4~5년치 일감)를 넘어섰다는 소식이 확인됐다. | [267260.KS](../../tickers/267260.KS - HD Hyundai Electric.md) |
| 효성중공업 | 초고압 변압기 — 미국 공장 증설 | ⚪ -0.02 (2026-09-11) | 이번 주 회사 자체 뉴스는 없었고, 두산에너빌리티發 훈풍이 부는 국내 전력기기 업종에서 직접 연관된 소식은 없었다. | [298040.KS](../../tickers/298040.KS - Hyosung Heavy Industries.md) |
| LS ELECTRIC | 배전기기·DC 전력 패키지 (Bloom 향 공급) | 🟢 +0.08 (2026-09-11) | 증권가는 LS ELECTRIC이 배전기기부터 초고압변압기까지 아우르는 패키지 수주로 성장을 이어갈 것으로 보고 목표주가·매수 의견을 유지했다. | [010120.KS](../../tickers/010120.KS - LS ELECTRIC.md) |
| Vertiv | DC 내부 전력체인 (UPS·PDU·부스웨이) | ⚪ -0.02 (2026-09-11) | 26억달러 규모 마이크로그리드 업체 인수로 사업을 넓혔지만, 통합 비용 우려와 AI 관련주 차익실현이 겹치며 이틀간 주가가 13% 넘게 빠졌다. | [VRT](../../tickers/VRT - Vertiv Holdings Co.md) |
<!-- PLAYERS_END -->
...
- ⬅ 수요측 [송전망 · 계통 인프라 건설](transmission.md) — 변압기·차단기 발주
- ⬅ 수요측 [BTM 구내·전용 발전 조달](btm.md) — 구내 변전 장비

## 관련 위키

- [AI 데이터센터 전력 인프라 — 내 판단](../../../syntheses/ai-datacenter-power-infrastructure.md)
- [LS일렉트릭](../../../entities/ls-electric.md)
- [DC 내부 전력·냉각 (AI·반도체 지도)](../ai-semiconductor/power-cooling.md)
