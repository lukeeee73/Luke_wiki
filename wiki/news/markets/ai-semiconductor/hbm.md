...
market_id: hbm
sources: ["https://counterpointresearch.com/en/insights/global-dram-and-hbm-market-share", "https://www.nextplatform.com/2025/12/19/hbm-supply-curve-gets-steeper-but-still-cant-meet-demand/", "https://www.trendforce.com/news/2026/08/10/news-samsungs-hbm4-yield-reportedly-hits-80-as-race-to-supply-vera-rubin-heats-up-sk-hynix-labor-talks-add-a-twist/", "https://www.digitimes.com/news/a20260812VL204/samsung-hbm4-sk-hynix-production-dram.html"]
---
...
> **지금 상황**: TrendForce·DigiTimes가 교차 확인한 바에 따르면, 삼성 HBM4(6세대 고대역폭메모리) 수율이 2월 60% 미만에서 8월 80%로 올라 연말 목표를 조기 달성했다. 베라루빈(NVIDIA 차세대 GPU)용 공급 경쟁이 3사(삼성·SK하이닉스·마이크론) 사이에서 재편되는 중이다.
> **왜 중요**: 대시보드 자동 신호는 이 소식을 근거로 병목 등급을 acute(급성)에서 easing(완화)으로 낮추자고 제안했지만, 이번 조사에서는 이를 기각했다 — 단일 공급사의 수율 개선일 뿐이고, TrendForce 자체 전망도 "전 3사 2026년까지 매진, 2027년 가격 최대 2배 상승"을 유지하고 있어 시장 전체의 매진 구조가 풀렸다고 보기엔 근거가 부족하기 때문이다. SK하이닉스 노사협상 변수도 3분기 공급 일정의 불확실성으로 남아있다.
> **투자자 관점**: 매진 상태가 유지되는 한 HBM은 여전히 파는 쪽이 가격을 결정하는 구조다. 삼성의 수율 개선은 물량 배정 경쟁에서 SK하이닉스를 다소 따라잡는 요인이 될 수 있지만, 시장 전체의 공급 여력이 늘었다고 판단하기는 아직 이르다.
<!-- SYNTHESIS_END -->
...
|---|---|---|---|---|
| SK Hynix | ~62% (HBM4 NVIDIA 최초 인증) · 점유 62% | ⚪ +0.03 (2026-08-25) | 전일 애플發 중국 메모리 우려로 10.37% 급락했지만 오늘 1~3% 반등하며 삼성 대비 상대적으로 견조했다. 핫칩스에서 HBM5용 인텔 EMIB 패키징 검토가 공개됐다 | [000660.KS](../../tickers/000660.KS - SK Hynix.md) |
| Micron | ~21% (’26 완판) · 점유 21% | 🔴 -0.10 (2026-08-25) | 애플의 중국 메모리(CXMT/YMTC) 조달 검토 보도와 넷리스트 특허소송으로 주가가 하락했지만, 8/26 엔비디아 실적을 앞두고 HBM 수요 기대는 유효하다 | [MU](../../tickers/MU - Micron Technology.md) |
| Samsung | ~17% (HBM4 Rubin 인증, 컴백중) · 점유 17% | 🔴 -0.13 (2026-08-25) | 역대 최대 110조원 주주환원을 발표했지만 자사주 소각 미확정에 시장이 실망하며 이틀 연속 급락했다. 핫칩스 2026 zHBM 공개는 기술적으로 긍정적이었다 | [005930.KS](../../tickers/005930.KS - Samsung Electronics.md) |
<!-- PLAYERS_END -->

## 시장 뉴스 로그 (최신순)

<!-- MARKET_NEWS_START -->
- **2026-08-10** ＋ **삼성 HBM4 수율 80%로 상승 — 베라루빈 공급 경쟁 가열, SK하이닉스는 노사협상 변수** — 2월 60%미만이던 수율이 목표치(연말 80%)를 조기 달성 — 3사 경쟁 구도 재편 (TrendForce) [↗](https://www.trendforce.com/news/2026/08/10/news-samsungs-hbm4-yield-reportedly-hits-80-as-race-to-supply-vera-rubin-heats-up-sk-hynix-labor-talks-add-a-twist/)
