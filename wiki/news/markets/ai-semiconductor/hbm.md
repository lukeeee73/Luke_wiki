...
|---|---|---|---|---|
| SK Hynix | ~62% (HBM4 NVIDIA 최초 인증) · 점유 62% | 🔴 -0.10 (2026-09-01) | 삼성전자의 HBM4 추격으로 수익성 전망이 낮아지며 역풍을 맞았지만 대규모 자사주 매입으로 일부 상쇄됐다 | [000660.KS](../../tickers/000660.KS - SK Hynix.md) |
| Micron | ~21% (’26 완판) · 점유 21% | 🟢 +0.09 (2026-09-01) | 연준의 매파적 발언에 반도체주가 주춤했지만 트럼프의 공개 지지와 9월 실적 기대감이 이를 상쇄하며 약한 순풍을 보였다 | [MU](../../tickers/MU - Micron Technology.md) |
| Samsung | ~17% (HBM4 Rubin 인증, 컴백중) · 점유 17% | 🟢 +0.17 (2026-09-01) | HBM4 수율 개선으로 목표주가가 오르고 D램 점유율 1위도 되찾으며 뚜렷한 순풍을 보였다 | [005930.KS](../../tickers/005930.KS - Samsung Electronics.md) |
<!-- PLAYERS_END -->
