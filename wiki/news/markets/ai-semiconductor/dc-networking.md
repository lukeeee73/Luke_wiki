...
| Arista | DC 이더넷 ~19% · 점유 20% | 🟢🟢 +0.27 (2026-08-10) | 아리스타는 사상 첫 30억달러 분기 실적을 내며 연간 목표치를 올해 세 번째로 올렸지만, 메모리 부품 공급이 빠듯해 수요를 다 채우지 못하는 상황은 계속되고 있다 | [ANET](../../tickers/ANET - Arista Networks, Inc.md) |
