...
<!-- FACTS_START -->
> [!fact] 텍사스주, 신규 데이터센터 전력망 접속 심사 일시 중단 — 2026-08-08 확인 · 텍사스 주지사실 공식 발표 + The Texas Tribune
> 텍사스 주지사가 전력망 부담을 이유로 데이터센터 전력망 접속 신청 전수 감사를 지시했고, 감사가 끝날 때까지 신규 프로젝트 진행이 사실상 멈췄다(2026-08-03). 왜 중요: 텍사스는 미국 데이터센터 신규 공급의 핵심 시장이라, 이 조치는 이 시장 전체(에퀴닉스·디지털리얼티 포함)의 확장 속도에 제동을 걸 수 있는 새로운 규제 리스크다.

> [!fact] PUCT, ERCOT의 감사 유예 요청 승인 — 감사 완료 시한 12월 10일로 연장 — 2026-08-20 확인 · Houston Public Media + KERA News
> 텍사스 공공요금위원회(PUCT)가 8/20 회의에서 ERCOT(텍사스 전력망 운영기관)의 "good-cause exception(정당한 사유에 의한 예외)" 요청을 승인해, 데이터센터 전력망 접속 전수 감사 완료 목표를 12월 10일로 정했다. 왜 중요: 신규 접속 심사의 즉각적·전면적 셧다운은 피했지만, 완전한 재개 시점은 여전히 12월 이후로 미뤄져 에퀴닉스·디지털리얼티의 텍사스 확장 프로젝트 불확실성이 당분간 이어진다.
<!-- FACTS_END -->
