...
- [ ] **2026-07-21**: 7/29 실적에서 모건스탠리의 낙관론($404 목표가, DRAM 수요 서프라이즈 기대)이 실제로 확인되는가 — 이렇게 확인된다: 9월 분기 가이던스가 컨센서스를 상회하는지 (시한 7/29)
- [ ] **2026-07-21**: CEO 포함 임원진의 연이은 자사주 매도가 추가로 이어지는가 — 이렇게 확인된다: 8월 중 SEC Form 4 공시로 추가 매도 여부 확인 (시한 8/15)
<!-- OPEN_CLAIMS_END -->
