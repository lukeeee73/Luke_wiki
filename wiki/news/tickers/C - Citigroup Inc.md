...
<!-- OPEN_CLAIMS_START -->
- [x] **2026-06-27**: $30B 자사주매입·블록체인 DDR 출시 — Q2 EPS 33.7% 증가 전망 실현 여부 (verified) ※ 2026-07-18: 2분기 실제 EPS $3.15로 전년($1.96) 대비 +60.7% 증가 — 당시 전망(+33.7%)을 크게 상회
- [ ] **2026-05-17**: 씨티 ROTCE 14-15% 중기 목표 — 구조개혁 진척도 추적 (pending) ※ 2026-06-06: Q1 매출 $24.6B +14% YoY 강세, 주가 다년간 고점 경신 — 구조개혁 성과 가시화 중, 목표 달성 가능성 높아짐 ※ 2026-07-18: 2분기 ROTCE 13%(상반기 13.1%)로 2027-28 목표 밴드(11-13%) 상단 도달 — 다만 원래 중기 목표인 14-15%에는 아직 못 미쳐 (pending 유지)
- [ ] **2026-05-17**: 씨티 아시아·중국 확장 승인 — 신흥시장 성장 동력 (pending) ※ 2026-06-06: 새로운 확인 뉴스 없음, 계속 모니터링 ※ 2026-07-18: 이번 주기에도 새로운 확인 뉴스 없음, 계속 모니터링
- [ ] **2026-06-13**: 씨티 블록체인 프라이빗에쿼티 플랫폼 채택률 — 주요 PE 사의 실제 사용 여부 7/14일 실적에서 확인 (pending) ※ 2026-07-18: 2분기 실적·컨퍼런스콜에서 DDR 플랫폼의 구체적 채택률·거래량 수치는 공개되지 않음 — 확인 시한을 다음 주기로 연장
- [ ] **2026-07-18**: 씨티의 비용 조기집행(인력감축·기술투자) 경고가 3분기 EPS 컨센서스 하향으로 이어지는가 (pending) — 이렇게 확인된다: 7/25 전후 애널리스트들의 3분기 EPS 컨센서스가 실적 발표 이전 대비 낮아지는지 (시한 7/25)
<!-- OPEN_CLAIMS_END -->
...
> [!fact] (확인: Citigroup IR/Business Wire 2026-07-14 + Yahoo Finance 2026-07-14) 2분기 순이익 $5.8B(+45% YoY), EPS $3.15로 애널리스트 전망(평균 $2.74) 전원 상회 — 10년래 최대 분기 매출 $24.8B
> 회사 공시와 복수 매체가 동일 수치 확인. 왜 중요: 구조개혁 이후 처음으로 목표 ROTCE 밴드 상단(13%)에 도달한 분기 — 실적만 보면 전환 전략이 숫자로 증명되고 있다는 근거.
<!-- FACTS_END -->
