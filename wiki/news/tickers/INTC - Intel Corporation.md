...
- [ ] **2026-07-21**: 18A 공정의 '수익성 있는' 수율 확보가 2027년으로 미뤄진 것이 실제 파운드리 고객 이탈로 이어지는가 — 이렇게 확인된다: 7/23 Q2 실적에서 파운드리 사업부 매출·손익 및 경영진 코멘트 (7/23 확인)
- [ ] **2026-07-21**: 데이터센터 매출 AMD 역전이 일시적인지 구조적 추세인지 — 이렇게 확인된다: 7/23 Q2 실적에서 서버 CPU 매출·점유율 변화 (7/23 확인)
