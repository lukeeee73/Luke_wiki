...
<!-- OPEN_CLAIMS_START -->
- [ ] **2026-06-27**: AI 협업·가이던스 상향이 75.7배 밸류에이션을 정당화할지 (pending) ※ 2026-07-18: 바클레이즈 등 목표주가 상향은 이어지나, CBO(최고사업책임자) 공백이라는 새 변수 추가 (pending)
- [ ] **2026-06-13**: EQIX 2026 연간 매출 $101~102억 가이던스 달성 여부 — Q2 실적(7/29) 확인 (pending) ※ 2026-07-18: 7/29 실적 발표 예정 확정 — CBO 교체 이후 첫 실적이라는 점에서 주목도 상승 (pending)
...
- [ ] **2026-05-17**: EQIX P/E 84배 — 고성장 프리미엄 지속 여부 (pending) — 2026-06-06: Citi 포커스리스트 추가 + $10B 가이던스로 프리미엄 정당성 지지 강화, 하이퍼스케일러 자체투자 리스크는 잔존 (pending) ※ 2026-07-18: 바클레이즈는 목표가는 올렸으나 등급은 Equal Weight(중립) 유지 — 밸류에이션 프리미엄에 대한 신중론 여전 (pending)
- [ ] **2026-07-18**: CBO(영업총괄) 공백이 AI Fabric 신규 계약 속도를 늦출지 — 이렇게 확인된다: 7/29 2분기 실적에서 AI Fabric 예약 증가율이 직전 분기(+70%) 대비 둔화되는지 (시한 7/29)
<!-- OPEN_CLAIMS_END -->
...
> [!fact] (확인: SEC 8-K 공시 + Yahoo Finance 2026-07-14) CBO 존 린, 7/18 퇴임 발표 — 후임 미정
> 왜 중요: 공식 8-K 공시와 복수 매체가 동일 사실을 확인 — AI Fabric 영업을 이끌던 핵심 임원의 이탈이 공식화됨.
<!-- FACTS_END -->
