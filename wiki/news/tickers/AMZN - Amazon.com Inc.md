...
- [ ] **2026-07-27**: KeyBanc 등 월가의 AWS 성장률 상향 기대(약 31% YoY, 수주잔고 4,850억달러)가 7/30 실제 실적으로 확인될지, 기대감만 앞선 것인지 — 이렇게 확인된다: 7/30 실적의 AWS 매출 성장률·영업이익률 (시한 8/6)
<!-- OPEN_CLAIMS_END -->
...
**앞으로 지켜볼 것**
- [ ] 7/30 2분기 실적 발표 — 확인할 것: AWS 실제 매출 성장률이 기대치(약 31%)에 부합하는지, 약 2,000억달러 규모 AI 데이터센터 capex 부담이 마진에 미치는 영향
