...
| Ticker | as_of | score | 핵심 한 줄 | open claims |
|---|---|---|---|---|
| [TSLA](tickers/TSLA - Tesla Inc.md) | 2026-06-24 | +0.09 | NHTSA 사망사고 FSD 320만대 특별조사, 16GW 가상발전소(선런)·Q2 인도 40~42만대 상향 | 3 |
| [TM](tickers/TM - Toyota Motor Corporation.md) | 2026-06-24 | +0.01 | 2026 누적 리콜 100만대 돌파, bZ·렉서스 RZ EV 리콜, 혼다 전고체 경쟁 압박 | 2 |
| [F](tickers/F - Ford Motor Company.md) | 2026-06-24 | -0.36 | 5월 美 판매 -13.6%(EV -44%), 42만대 안전벨트 리콜, GM 실버라도 픽업 경쟁 심화 | 2 |
| [GM](tickers/GM - General Motors Company.md) | 2026-06-24 | +0.20 | 록히드마틴 무기·탄약 양산 MOU, 2027 실버라도 공개, 낮은 EV·FSD 규제 노출 | 1 |
| [STLA](tickers/STLA - Stellantis NV.md) | 2026-06-24 | -0.07 | 웨이브·우버 글로벌 로보택시 파트너십, 마세라티 매각 부인, 투자자 집단소송 마감 임박 | 2 |
| [HMC](tickers/HMC - Honda Motor Co.md) | 2026-06-24 | +0.12 | 퀀텀스케이프 전고체 공동개발 합의(~1,000km), 88만대 후방 서브프레임 리콜 | 2 |
| [RIVN](tickers/RIVN - Rivian Automotive.md) | 2026-06-24 | -0.15 | R2 SUV 인도 개시(양산 이정표), 2% 감원·고가 리스·NHTSA 조사로 투자심리 악화 | 3 |
| [NIO](tickers/NIO - NIO Inc.md) | 2026-06-24 | +0.10 | 5월 인도 +62.3%·ES9/ONVO 호조·70만대 OTA, 펜타곤 군수기업 리스트 리스크 | 2 |
| [005380.KS](tickers/005380.KS - Hyundai Motor Company.md) | 2026-06-24 | +0.15 | 5월 美 하이브리드 월간 최대(+90%)·점유율 11.8%(포드 추격), 노조 파업 86% 가결 | 3 |
| [000270.KS](tickers/000270.KS - Kia Corporation.md) | 2026-06-24 | +0.16 | 5월 美 판매 역대 최고, 스포티지 HEV 조지아 현지생산(관세 회피)·HEV +171% | 1 |
...
| Ticker | as_of | score | 핵심 한 줄 | open claims |
|---|---|---|---|---|
| [329180.KS](tickers/329180.KS - HD Hyundai Heavy Industries.md) | 2026-06-24 | +0.12 | KDDX 평가 이의신청(6/22)·가처분 기각 항고, 본업 LNGC·미 해군 MRO 견고 | 2 |
| [042660.KS](tickers/042660.KS - Hanwha Ocean Co.md) | 2026-06-24 | +0.39 | KDDX ₩7.8조 선도함 우선협상 선정, 60조 캐나다 잠수함 정조준, 주가 7%대 강세 | 2 |
| [010140.KS](tickers/010140.KS - Samsung Heavy Industries.md) | 2026-06-24 | +0.34 | LNG운반선 3855억 수주·연간 목표 61%·상선 91% 달성, 방산 분쟁서 비켜난 안정성 | 2 |
...
## 오늘의 시그널 (2026-06-24 · 수요일 · 자동차 / 모빌리티 + 조선 (한국))

**2026-06-24 감지된 시그널:**

- **최고 시그널 (042660.KS +0.39)**: KDDX ₩7.8조 선도함 우선협상대상자 선정 모멘텀 지속 + 60조 캐나다 잠수함·필리조선소 성장축. 다만 HD현대중공업의 6/22 이의신청·항고가 우선협상 지위 확정의 절차적 변수로 잔존.
- **역방향 지속 (329180.KS +0.12 ↔ 042660.KS +0.39)**: KDDX 패자/승자 구도 2주째 유지. HD현대중공업은 본업(상선·LNGC·미 해군 MRO)이 견고해 -0.18→+0.12로 낙폭 축소했으나 방산 법적 분쟁이 상단을 제약.
- **섹터 동기화 (K-조선 LNG·방산 수퍼사이클)**: 042660.KS(+0.39) + 010140.KS(+0.34) + 329180.KS(+0.12) — 방산(KDDX)·LNG/FLNG·미 해군 MRO 세 축이 동시 강세. 후판가 인상 협상·환율이 공통 하방 변수.
- **섹터 동기화 (현대차그룹 미국 현지화·하이브리드)**: 005380.KS(+0.15) + 000270.KS(+0.16) — 5월 美 하이브리드 기록적 판매 + 조지아 HMGMA 현지생산(스포티지 HEV)으로 15% 관세 회피. 현대차 노조 파업 86% 가결이 그룹 공통 단기 변수.
- **섹터 동기화 (레거시 완성차 리콜·EV 둔화)**: F(-0.36) + TM(+0.01) + HMC(+0.12) — 포드 42만대·토요타 누적 100만대·혼다 88만대 리콜이 동시 부각, 미국 EV 수요 둔화(F EV -44%)가 겹침. 품질 비용이 완성차 섹터 공통 헤드윈드.
- **차별화 (전동화 기술 베팅)**: HMC(+0.12, 퀀텀스케이프 전고체) + STLA(-0.07, 웨이브·우버 로보택시) — 리콜·소송 악재 속에서도 차세대 기술 파트너십으로 경쟁 포지셔닝 차별화 시도.
- **최대 악재 (F -0.36)**: 5월 판매 -13.6%·EV -44%·42만대 리콜·GM 실버라도 경쟁까지 4중 악재 동조. 완성차 그룹 내 단연 최저 시그널.
- **TSLA 양면성 (+0.09)**: NHTSA 사망사고 FSD 특별조사(규제 -0.60)라는 핵심 악재와 16GW 가상발전소·Q2 인도 상향(긍정)이 상쇄돼 중립 부근.
- **주목 이벤트**: 현대차 중노위 조정 결과(6/25)·파업 돌입 여부, KDDX 이의신청·항고 결정, NIO 펜타곤 리스트 법적 대응, STLA 12월 마세라티 전략 발표, 기아 다음 실적(7/17).
