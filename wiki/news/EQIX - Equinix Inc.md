...
**Equinix, Inc.** · Real Estate · 부동산 (REITs) · 경쟁사: DLR, AMT, IRM

## 회사 소개

전 세계 데이터센터를 운영하는 REITs. 데이터센터란 서버 컴퓨터를 수천 대 모아놓은 대형 건물로, 인터넷과 클라우드 서비스의 물리적 기반이다. AI와 클라우드 수요가 폭발적으로 늘면서 데이터센터 부동산 가치가 급등하고 있다.
